...
However if you want to extend your watchtower to a traffic light, you need some more parts than shown above and there are some additional steps to take. All those steps are indicated on the bottom right with a sign that tells you where you have to leave the standard watchtower instructions. Please make sure to do those additional steps in the very order they are indicated and jump back to the standard watchtower instructions where it says "Continue with ..."
...
### Step 29
Put the top lid on the camera housing for protection of the camera.
...
<img src="opmanual_autolab/images/watchtower/WT19-B_assembly/WT19-B_complete.png" style="width: 30%"/>
<figcaption>
...
If you have done all additional steps for the traffic light extension as well, you should have arrived at a result like the one in figure [](#fig:WT19-B_TL_complete):
...
Congratulations, you now finished this instruction page!
